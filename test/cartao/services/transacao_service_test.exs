defmodule Cartao.Services.TransacaoServiceTest do
  use Cartao.DataCase
  alias Cartao.Services.TransacaoService
  alias Cartao.{Repo}

  setup do
    # Limpar registros existentes de MCC antes de inserir novos
    Repo.delete_all(Cartao.Mccs)
    ...
    _cc_food =
      %Cartao.ContasCarteiras{}
      |> Cartao.ContasCarteiras.changeset(%{
        conta_id: conta.id,
        carteira_id: food.id,
