defmodule Cartao.Transacoes do
  @moduledoc """
  ...
  schema "transacoes" do
    ...
    belongs_to :conta, Cartao.Contas, foreign_key: :conta_id
    belongs_to :carteira, Cartao.Carteiras, foreign_key: :carteira_id, references: :id
  end
