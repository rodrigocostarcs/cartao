...
config :cartao, Cartao.Repo, pool: Ecto.Adapters.SQL.Sandbox
...
config :cartao, Cartao.Repo,
  ...
  database: "cartao_test#{System.get_env("MIX_TEST_PARTITION")}",
...
config :cartao, Cartao.Mailer, adapter: Swoosh.Adapters.Test
